...
COHORT = [
  ...
  dict(id="tesla-model-y-new", name="Tesla Model Y Long Range AWD", short="Model Y LR (new)",
       ...
       scores=dict(car_seat_fit=5,cargo=5,third_row=1,corridor=5,hitch=4,reliability=4,winter=4,fsr=3),
  ...
  dict(id="tesla-model-3-used", name="Tesla Model 3 Long Range (2022-23)", short="Model 3 (used)",
       ...
       scores=dict(car_seat_fit=4,cargo=3,third_row=1,corridor=5,hitch=1,reliability=4,winter=3,fsr=1),
  ...
  dict(id="tesla-model-3-new", name="Tesla Model 3 Long Range AWD", short="Model 3 LR (new)",
       ...
       scores=dict(car_seat_fit=4,cargo=3,third_row=1,corridor=5,hitch=1,reliability=4,winter=4,fsr=1),
  ...
  dict(id="ev6-used", name="Kia EV6 AWD (2022-23)", short="EV6 (used)",
       ...
       scores=dict(car_seat_fit=4,cargo=3,third_row=1,corridor=4,hitch=3,reliability=4,winter=4,fsr=2),
